        ...
        @else
            <style>
                :root {
                    ...
                    --color-primary-on-dark: #93c5fd;
                    --color-primary-surface-dark: #0f172a;
                    --color-primary-mark: #bfdbfe;
                    --color-primary-mark-dark: #1e3a8a;
                }
                ...
                *, ::before, ::after {
                ...
                .text-\[\#1B1B18\], .text-\[\#1b1b18\] { color: #1B1B18; }
                .text-\[\#60a5fa\] { color: #60a5fa; }
                .text-\[\#706f6c\] { color: #706f6c; }
                .text-white { color: #fff; }
                .text-primary { color: var(--color-primary); }
                .text-primary-mark { color: var(--color-primary-mark); }
                ...
                .shadow-\[0px_0px_1px_0px_rgba\(0\,0\,0\,0\.03\)\,0px_1px_2px_0px_rgba\(0\,0\,0\,0\.06\)\] { box-shadow: 0 0 1px 0 rgba(0, 0, 0, 0.03), 0 1px 2px 0 rgba(0, 0, 0, 0.06); }
                .shadow-\[inset_0px_0px_0px_1px_rgba\(26\,26\,0\,0\.16\)\] { box-shadow: inset 0 0 0 1px rgba(26, 26, 0, 0.16); }
                ...
                .before\:bottom-1\/2::before { bottom: 50%; }
                .before\:left-\[0\.4rem\]::before { left: 0.4rem; }
                .before\:border-l::before { border-left-width: 1px; }
                .before\:border-\[\#e3e3e0\]::before { border-color: #e3e3e0; }

                @media (hover: hover) {
                    .hover\:border-\[\#19140035\]:hover { border-color: #19140035; }
                    .hover\:border-\[\#1915014a\]:hover { border-color: #1915014a; }
                    .hover\:border-primary-hover:hover { border-color: var(--color-primary-hover); }
                ...
                @media (prefers-color-scheme: dark) {
                    body, .dark\:bg-\[\#0a0a0a\] { background-color: #0a0a0a; }
                    .dark\:bg-\[\#161615\] { background-color: #161615; }
                    .dark\:bg-\[\#3E3E3A\] { background-color: #3E3E3A; }
                    .dark\:bg-primary-on-dark { background-color: var(--color-primary-on-dark); }
                    .dark\:bg-primary-surface-dark { background-color: var(--color-primary-surface-dark); }
                    .dark\:border-\[\#3E3E3A\] { border-color: #3E3E3A; }
                    .dark\:border-primary-on-dark { border-color: var(--color-primary-on-dark); }
                    .dark\:text-\[\#1C1C1A\] { color: #1C1C1A; }
                    .dark\:text-\[\#1d4ed8\] { color: #1d4ed8; }
                    .dark\:text-\[\#1e40af\] { color: #1e40af; }
                    .dark\:text-\[\#A1A09A\] { color: #A1A09A; }
                    .dark\:text-\[\#EDEDEC\] { color: #EDEDEC; }
                    .dark\:text-black { color: #000; }
                    .dark\:text-primary-mark-dark { color: var(--color-primary-mark-dark); }
                    .dark\:text-primary-on-dark { color: var(--color-primary-on-dark); }
                    .dark\:mix-blend-hard-light { mix-blend-mode: hard-light; }
                    .dark\:mix-blend-normal { mix-blend-mode: normal; }
                    .dark\:shadow-\[inset_0px_0px_0px_1px_\#fffaed2d\] { box-shadow: inset 0 0 0 1px #fffaed2d; }
                    .dark\:\[--stroke-color\:\#93c5fd\] { --stroke-color: #93c5fd; }
                    .dark\:before\:border-\[\#3E3E3A\]::before { border-color: #3E3E3A; }
                }

                @media (prefers-color-scheme: dark) and (hover: hover) {
                    .dark\:hover\:border-\[\#3E3E3A\]:hover { border-color: #3E3E3A; }
                    .dark\:hover\:border-\[\#62605b\]:hover { border-color: #62605b; }
                    .dark\:hover\:border-white:hover { border-color: #fff; }
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-6 lg:p-20 lg:pb-10 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    ...
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                            ...
                            <span>
                                Read the
                                <a href="https://laravel.com/docs" target="_blank" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-primary dark:text-primary-on-dark ml-1">
                        ...
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                            ...
                            <span>
                                ...
                                <a href="https://laracasts.com" target="_blank" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-primary dark:text-primary-on-dark ml-1">
                                    <span>Laracasts</span>
                                    <svg
                                        width="10"
                                        height="11"
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a href="https://cloud.laravel.com" target="_blank" class="inline-block bg-primary hover:bg-primary-hover border-primary hover:border-primary-hover dark:bg-primary-on-dark dark:border-primary-on-dark dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white px-5 py-1.5 rounded-sm border text-white text-sm leading-normal">
                                Deploy now
                            </a>
                        </li>
                    </ul>
                    ...
                    <p class="mt-6 lg:mt-10 text-[#706f6c] dark:text-[#A1A09A]">
                        v{{ app()->version() }}
                        <a href="https://github.com/laravel/framework/blob/13.x/CHANGELOG.md" target="_blank" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-primary dark:text-primary-on-dark ml-1">
                ...
                <div class="bg-primary-soft dark:bg-primary-surface-dark relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/364] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                    {{-- Laravel Logo --}}
                    <svg class="w-full text-primary dark:text-primary-on-dark transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 motion-safe:starting:translate-y-6" viewBox="0 0 438 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- 13 --}}
                    <svg class="w-[438px] max-w-none relative -mt-[6.6rem] -ml-8 lg:ml-0 [--stroke-color:#1B1B18] dark:[--stroke-color:#93c5fd]" viewBox="0 0 440 392" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g class="transition-all delay-400 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[26px] text-primary-mark dark:text-primary-mark-dark">
                        ...
                        <g class="mix-blend-color dark:mix-blend-hard-light transition-all delay-400 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[51px] text-[#60a5fa] dark:text-[#1d4ed8]">
                        ...
                        <g class="mix-blend-multiply dark:mix-blend-normal transition-all delay-400 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[78px] text-primary-mark dark:text-[#1e40af]">
                        ...
                        <g class="mix-blend-hard-light transition-all delay-400 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[102px] text-primary-mark dark:text-primary-mark-dark">
