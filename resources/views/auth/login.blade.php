        ...
        <div class="relative isolate min-h-screen overflow-hidden px-4 py-8 sm:px-6 lg:px-8">
            ...
            <main class="mx-auto flex w-full max-w-lg flex-col justify-center gap-6">
                <header class="text-center">
                    ...
                    <p class="mt-2 text-sm text-slate-300">Sign in to access your Todo Ape workspace.</p>
                </header>
                    ...
                    <form method="POST" action="{{ route('login.store') }}" class="space-y-5" novalidate>
                        ...
                        <label class="inline-flex items-center gap-2 text-sm text-slate-200">
                            <input
                                ...
                                class="size-4 rounded border-slate-700 bg-slate-900 accent-cyan-300"
                            >
                ...
                <p class="text-center text-sm text-slate-300">
                    No account yet?
                    <a href="{{ $registerUrl }}" class="font-semibold text-cyan-200 hover:text-cyan-100">Create account</a>
                </p>
            </main>
        </div>
    </body>
